<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Material-reciept-note.aspx.cs" Inherits="administrator.Material_reciept_note" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div>
<fieldset>
<legend>Material Reciept Note</legend>
<table>
<tr>
<td>
...
<td>
    <asp:Label ID="Label15" runat="server" Text="GR No:"></asp:Label>
</td>
<td>
...
<asp:TemplateField HeaderText="QC Parameter" />
    </Columns>
    </asp:GridView>
</fieldset>
<fieldset>
