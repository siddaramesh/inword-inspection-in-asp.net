<%@ Page Title="Inductor Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ms-inductor.aspx.cs" Inherits="administrator.ms_inductor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<p>
    <asp:HyperLink ID="HyperLink2" NavigateUrl="~/Default.aspx" ForeColor="Blue" Font-Size="15px" runat="server">Admin</asp:HyperLink><span style="color:Black; font-size:14px;">>>Inductor</span>
</p>
<div class="masterdetails">
 ...
 <li> <asp:HyperLink ForeColor="Black" CssClass="font"  ID="msinductor" runat="server">Inductor</asp:HyperLink></li>
 <li> <asp:HyperLink ForeColor="Gray" CssClass="font" NavigateUrl="~/ms-barepcb.aspx" ID="msbarepcb" runat="server">BARE PCB</asp:HyperLink></li>
  ...
  <legend>Inductor Masters</legend>
  <table>
  <tr>
  <td>
  ...
  <td>
  <asp:Label CssClass="label" ID="Label3" runat="server" Text="Tinning Soldering:"></asp:Label>
  </td>
  <td>
  ...
  <tr>
  <td>
  <asp:Label CssClass="label" ID="Label4" runat="server" Text="Put size in BARE PCB:"></asp:Label>
  </td>
  <td>
  ...
  <td>
  <asp:Label CssClass="label" ID="Label5" runat="server" Text="Lead Length:"></asp:Label>
  </td>
  <td>
  ...
  <td>
  <asp:Label CssClass="label" ID="Label6" runat="server" Text="Solderability:"></asp:Label>
  </td>
  <td>
  ...
  <tr>
  <td>
  <asp:Label CssClass="label" ID="Label7" runat="server" Text="DCR:"></asp:Label>
  </td>
  <td>
