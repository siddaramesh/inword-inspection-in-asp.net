<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tinning.aspx.cs" Inherits="administrator.tinning" %>
...
<body>
  ...
  <legend>Tinning and soldering</legend>
  <table>
  <tr>
  <td>
  ...
  <td>
      <asp:DropDownList CssClass="textbox" ID="DropDownList21" AutoPostBack="true" 
          runat="server" onselectedindexchanged="DropDownList21_SelectedIndexChanged">
  ...
  <td>
      <asp:Label ID="soldering" Font-Bold="true" runat="server" Text="Tinning and Soldering"></asp:Label>
  </td>
  </tr>
  <tr>
  <td>
