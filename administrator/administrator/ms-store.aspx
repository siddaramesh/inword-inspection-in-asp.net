<%@ Page Title="STORE MASTER" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ms-store.aspx.cs" Inherits="administrator.ms_store" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div class="description">
<fieldset class="borderradius">
<legend>Store Master</legend>
<p>
...
<tr>
<td>
    <asp:Label ID="Label2" runat="server" CssClass="label" Text="Store Name:"></asp:Label>
</td>
<td>
