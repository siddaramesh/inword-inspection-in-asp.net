<%@ Page Title="PowerSupply A" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="powerA.aspx.cs" Inherits="administrator.powerA" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<p>
    <asp:HyperLink ID="HyperLink2" NavigateUrl="" ForeColor="Blue" Font-Size="15px" runat="server">Inward Inspection</asp:HyperLink><span style="color:Black; font-size:14px;">>>PowerSupply A</span>
</p>
...
<div class=" search">
 ...
 <td>
  ...
  <td>
   ...
   <div class=" search">
  <fieldset class=" radiusright">
  <legend>Process Inspection</legend>
  <table>
  <tr>
  <td>
