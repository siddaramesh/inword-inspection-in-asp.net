<%@ Page Title="Consumables" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="consumableshome.aspx.cs" Inherits="administrator.consumableshome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
<script type="text/javascript" src="http://code.jquery.com/jquery-1.8.2.js"></script>
<script type="text/javascript">
    var popup, tin, lead, dcr;
    function popupnew() {
        popup = window.open("ms-consumables.aspx", "popup", "width=850,height=450");
        popup.focus();
        return false;
    }
    function popupedit() {
