<%@ Page Title="Bare PCB" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="bare-pcb.aspx.cs" Inherits="administrator.bare_pcb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<p>
    <asp:HyperLink ID="HyperLink2" NavigateUrl="" ForeColor="Blue" Font-Size="15px" runat="server">Inward Inspection</asp:HyperLink><span style="color:Black; font-size:14px;">>>BARE PCB</span>
</p>
