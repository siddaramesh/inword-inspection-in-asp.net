<%@ Page Title="Unit Of Measure" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="unitofmeasure.aspx.cs" Inherits="administrator.unitofmeasure" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<p>
    <asp:HyperLink ID="HyperLink2" NavigateUrl="~/Default.aspx" ForeColor="Blue" Font-Size="15px" runat="server">Admin</asp:HyperLink><span style="color:Black; font-size:14px;">>>Unit Of Measure</span>
</p>
...
<li>      <asp:HyperLink CssClass="font" ForeColor="Gray" NavigateUrl="~/supplier.aspx" ID="supplierid" runat="server">Supplier Details</asp:HyperLink></li>
  ...
  <li>     <asp:HyperLink ForeColor="Black" CssClass="font" NavigateUrl="" ID="uom" runat="server">Unit Of Measure</asp:HyperLink></li>
 ...
 <li>     <asp:HyperLink ForeColor="Gray" CssClass="font" NavigateUrl="~/ms-barepcb.aspx" ID="msbarepcb" runat="server">BARE PCB</asp:HyperLink></li>
  ...
  <tr>
   <td>
       <asp:Label ID="Label7" runat="server" Text="Unit Of Measure:"></asp:Label>
   </td>
   <td>
  ...
  <tr>
  <td>
      <asp:Label CssClass="label" ID="Label6" runat="server" Text="Unit Of Measure:"></asp:Label>
  </td>
  <td>
      <asp:TextBox CssClass="textbox" ID="TextBox1" Width="50px" runat="server"></asp:TextBox>
  ...
  <tr>
  <td>
      <asp:Label CssClass="label" ID="Label1" runat="server" Text="Description:"></asp:Label></td>
  <td>
