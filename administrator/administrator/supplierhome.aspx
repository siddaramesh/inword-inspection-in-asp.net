<%@ Page Title="Supplier" Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="supplierhome.aspx.cs" Inherits="administrator.supplierhome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
<script type="text/javascript" src="http://code.jquery.com/jquery-1.8.2.js"></script>
<script type="text/javascript">
    var popup, tin, lead, dcr;
    function popupnew() {
        popup = window.open("supplier.aspx", "popup", "width=1000,height=500");
        popup.focus();
        return false;
    }
    function popupedit() {
