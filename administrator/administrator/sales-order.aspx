<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sales-order.aspx.cs" Inherits="administrator.sales_order" %>
...
<td>
    <asp:Label ID="Label14" runat="server" Text="Quot.No:"></asp:Label>
</td>
<td>
    <asp:TextBox ID="TextBox11" runat="server"></asp:TextBox>
</td>
<td>
    <asp:Label ID="Label15" runat="server" Text="Quot.Date:"></asp:Label>
</td>
<td>
...
<asp:TemplateField HeaderText="P. Order Qty" />
