...
{
    public partial class tinning : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Session["tinningyes"] = Label23.Text;
            Session["tinningno"] = Label25.Text;
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            Session["tinningyes"] = Label23.Text;
            Session["tinningno"] = Label25.Text;
            ScriptManager.RegisterStartupScript(this, GetType(), "tinning", "tinning();", true);
        }
    }
}