...
namespace administrator
{
    public partial class primary : System.Web.UI.Page
    {
        ...
        {
           // ScriptManager.RegisterClientScriptBlock(this, GetType(), "none", "<script>getrowvalue('" + Label87.Text + "');</script>", false);
          //  ScriptManager.RegisterStartupScript(this, GetType(), "select", "getvalue();", true);
          //  Button2.Attributes.Add("onclick", "javascript: return getrowvalue('" + Label87.Text + "');");
        }

        protected void Button2_Click1(object sender, EventArgs e)
        {
            //textbox values
            Session["ptextbox1"] = TextBox1.Text;
            Session["ptextbox2"] = TextBox2.Text;
            Session["ptextbox3"] = TextBox3.Text;
            Session["ptextbox4"] = TextBox4.Text;
            Session["ptextbox5"] = TextBox5.Text;
            Session["ptextbox6"] = TextBox6.Text;
            Session["ptextbox7"] = TextBox7.Text;
            Session["ptextbox8"] = TextBox8.Text;
            Session["ptextbox9"] = TextBox9.Text;
            Session["ptextbox10"] = TextBox10.Text;
            Session["ptextbox11"] = TextBox11.Text;
            Session["ptextbox12"] = TextBox12.Text;
            Session["ptextbox13"] = TextBox13.Text;
            Session["ptextbox14"] = TextBox14.Text;
            Session["ptextbox15"] = TextBox15.Text;
            Session["ptextbox16"] = TextBox16.Text;
            Session["ptextbox17"] = TextBox17.Text;
            Session["ptextbox18"] = TextBox18.Text;
            Session["ptextbox19"] = TextBox19.Text;
            Session["ptextbox20"] = TextBox20.Text;
            //label values
            Session["plabel1"] = Label9.Text;
            Session["plabel2"] = Label13.Text;
            Session["plabel3"] = Label17.Text;
            Session["plabel4"] = Label21.Text;
            Session["plabel5"] = Label25.Text;
            Session["plabel6"] = Label29.Text;
            Session["plabel7"] = Label33.Text;
            Session["plabel8"] = Label37.Text;
            Session["plabel9"] = Label41.Text;
            Session["plabel10"] = Label45.Text;
            Session["plabel11"] = Label49.Text;
            Session["plabel12"] = Label53.Text;
            Session["plabel13"] = Label57.Text;
            Session["plabel14"] = Label61.Text;
            Session["plabel15"] = Label65.Text;
            Session["plabel16"] = Label69.Text;
            Session["plabel17"] = Label73.Text;
            Session["plabel18"] = Label77.Text;
            Session["plabel19"] = Label81.Text;
            Session["plabel20"] = Label85.Text;

            Session["outofrange"] = TextBox21.Text;
            ScriptManager.RegisterStartupScript(this, GetType(), "getvalue", "getvalue();", true);
        }
    }
}