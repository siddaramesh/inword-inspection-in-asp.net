<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncomingMaterialRecievedByCustomer.aspx.cs" Inherits="administrator.IncomingMaterialRecievedByCustomer" %>
...
<tr>
<td>
    <asp:Label ID="Label3" runat="server" Text="Challen No:"></asp:Label>
</td>
<td>
...
<tr>
<td>
    <asp:Label ID="Label16" runat="server" Text="GR No:"></asp:Label>
</td>
<td>
    <asp:TextBox ID="TextBox13" runat="server"></asp:TextBox>
</td>
<td>
    <asp:Label ID="Label51" runat="server" Text="GR Date"></asp:Label>
</td>
<td>
...
<asp:TemplateField HeaderText="QC Parameters" />
    </Columns>
    </asp:GridView>
</fieldset>
<fieldset>
