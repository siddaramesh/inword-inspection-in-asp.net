<%@ Page Title="Approved By" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="approved.aspx.cs" Inherits="administrator.approved" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<p>
    <asp:HyperLink ID="HyperLink2" NavigateUrl="~/Default.aspx" ForeColor="Blue" Font-Size="15px" runat="server">Admin</asp:HyperLink><span style="color:Black; font-size:14px;">>>Approved By</span>
</p>
...
<li>      <asp:HyperLink CssClass="font" ForeColor="Gray" NavigateUrl="~/inspected.aspx" ID="inspectedid" runat="server">Inspected By</asp:HyperLink></li>
<li>      <asp:HyperLink ForeColor="Black" CssClass="font" ID="approvedid" runat="server">Approved By</asp:HyperLink></li>
